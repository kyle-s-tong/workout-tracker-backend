 ...
 */
final class Version20190908013749 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise_record ADD sets JSON NOT NULL COMMENT \'(DC2Type:json_array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercise_record DROP sets');
    }
}
